...
void pp_callback(const visualization::PointPickingEvent& event,
		void* viewer_void) {
	...
	cout << "select point: " << selected_point.x << " " << selected_point.y
			<< " " << selected_point.z << endl;
//	cout << event.getPointIndex (); 
	...
	if (num_points == 1) {
		...
		cout << "angle: "
				<< calculate_angleA(origin, first_point, selected_point)
				<< endl;
	}
...
int main(int argc, char** argv) {
	...
	pcl::console::print_info(
			"Hold shift key + click on the point in points cloud\n");
